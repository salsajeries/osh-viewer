                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            ...
                                            if (!!this.status.cancel) return [3 /*break*/, 4];
                                            return [4 /*yield*/, this.context.nextBatch()];
                                        case 3:
                                            data_1 = _a.sent();
                                            if (data_1.length > 0) {
...
var TimeSeriesHandler = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.properties = __assign(__assign(__assign({}, this.properties), properties), { dataSourceId: dataSourceId });
    ...
    TimeSeriesHandler.prototype.connect = function (startTime, version) {
        if (startTime === void 0) { startTime = this.properties.startTime; }
        if (version === void 0) { version = this.properties.version; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.properties.version = version;
                        return [4 /*yield*/, this.checkDisconnect()];
                    case 1:
                        _a.sent();
