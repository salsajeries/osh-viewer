...
var SosGetResult = /** @class */ (function (_super) {
    ...
    function SosGetResult(name, properties) {
        return _super.call(this, name, __assign({ protocol: 'ws', service: "SOS", timeShift: 0, reconnectTimeout: 1000 * 5, reconnectRetry: 10, tls: true, type: 'SosGetResult', mode: Mode.REAL_TIME, prefetchBatchSize: 250, prefetchBatchDuration: 5000 }, properties)) || this;
    }
    return SosGetResult;
