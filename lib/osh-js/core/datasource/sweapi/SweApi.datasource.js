...
var SweApi = /** @class */ (function (_super) {
    ...
    function SweApi(name, properties) {
        return _super.call(this, name, __assign({ reconnectTimeout: 1000 * 5, reconnectRetry: 10, startTime: 'now', endTime: '2055-01-01T00:00:00Z', tls: false, responseFormat: 'application/swe+json', protocol: 'http', type: 'SweApiStream', mode: Mode.REAL_TIME, prefetchBatchSize: 250, prefetchBatchDuration: 5000, connectorOpts: {} }, properties)) || this;
    }
