...
var FeaturesOfInterest = /** @class */ (function (_super) {
    ...
    function FeaturesOfInterest(networkProperties) {
        ...
        _this.sweApiFetchParser = new SweApiFetchFeatureOfInterestParser(networkProperties);
        return _this;
    }
    /**
    ...
    FeaturesOfInterest.prototype.searchFeaturesOfInterest = function (featureOfInterestFilter, pageSize) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Collection(this.baseUrl() + API.fois.search, featureOfInterestFilter, pageSize, this.sweApiFetchParser)];
            });
        });
    };
    /**
