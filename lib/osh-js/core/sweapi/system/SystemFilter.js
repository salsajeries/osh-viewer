...
var SystemFilter = /** @class */ (function (_super) {
    ...
    function SystemFilter(properties) {
        return _super.call(this, __assign({ q: undefined, bbox: undefined, location: undefined, parent: undefined, foi: undefined, select: undefined, format: 'application/json', validTime: undefined }, properties // merge defined properties
        )) || this;
        //TODO: assertions
    }
    return SystemFilter;
