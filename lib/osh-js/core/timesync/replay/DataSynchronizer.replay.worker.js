        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    dataSynchronizerAlgo = new DataSynchronizerAlgoReplay(event.data.dataSources, replaySpeed, startTimestamp, endTimestamp, event.data.timerResolution, version);
                ...
                case 4:
                    ...
                    return [3 /*break*/, 8];
                case 5:
                    if (!(event.data.message === 'remove')) return [3 /*break*/, 7];
...
function setTimeRange(startTimestamp, endTimestamp, mode, replaySpeed, newVersion, dsArray) {
    reset();
    version = newVersion;
    dataSynchronizerAlgo = new DataSynchronizerAlgoReplay(dsArray, replaySpeed, startTimestamp, endTimestamp, timerResolution, version);
...
function initBroadcastChannel(dataTopic, timeTopic) {
    ...
    dataSynchronizerBroadCastChannel.onmessage = function (event) { return __awaiter(_this, void 0, void 0, function () {
        var dataSourceId;
        return __generator(this, function (_a) {
...
function removeDataSources(dataSourceIds) {
    for (var _i = 0, dataSourceIds_1 = dataSourceIds; _i < dataSourceIds_1.length; _i++) {
        var dataSourceId = dataSourceIds_1[_i];
...
//# sourceMappingURL=DataSynchronizer.replay.worker.js.map