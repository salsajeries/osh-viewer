            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, fnArr[i](records[j].data, records[j].data.timestamp, options, this)];
                    case 3:
                        _a.sent();
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 1];
                    case 7:
                        if (!isDefined(this.noDataSourcesFn)) return [3 /*break*/, 14];
                        fnArr = this.noDataSourcesFn;
                        this.props.filter = true;
                        j = 0;
                        _a.label = 8;
                    case 8:
                        if (!(j < records.length)) return [3 /*break*/, 14];
                        i = 0;
                        _a.label = 9;
                    case 9:
                        if (!(i < fnArr.length)) return [3 /*break*/, 12];
