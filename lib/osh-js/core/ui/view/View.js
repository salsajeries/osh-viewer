 ...
 */
import { assertArray, assertBoolean, assertDefined, assertString, assertTrue, isDefined, randomUUID } from '../../utils/Utils.js';
...
var View = /** @class */ (function () {
    ...
    View.prototype.destroy = function () {
        ...
        for (var _i = 0, _a = this.broadcastChannels; _i < _a.length; _i++) {
            var bc = _a[_i];
            bc.close();
