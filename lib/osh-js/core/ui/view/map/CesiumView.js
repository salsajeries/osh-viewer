    ...
    CesiumView.prototype.beforeAddingItems = function (options) {
        ...
        if (options && options.options) {
            if (options.options.location &&
                ...
                cameraOpts.destination = Cartesian3.fromDegrees(options.options.location.longitude, options.options.location.latitude, options.options.location.altitude);
            }
        ...
        if (cameraOpts) {
            this.viewer.camera.flyTo(__assign(__assign({}, cameraOpts), { duration: 1.0 }));
        }
