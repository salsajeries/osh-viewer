        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!isDefined(ffmpegDecoder)) return [3 /*break*/, 2];
                    return [4 /*yield*/, ffmpegDecoder.decode(e.data)];
                case 1:
                    decodedFrame = _a.sent();
...
//# sourceMappingURL=ffmpeg.decode.video.worker.js.map