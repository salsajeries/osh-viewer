...
class MjpegView extends View {
    ...
    constructor(properties) {
        ...
        if (typeof (properties) != "undefined" && typeof (properties.rotation) != "undefined") {
            ...
            console.log('[MjpegView] Dimensions WxH: ', properties.width, properties.height);
            ...
            console.log('[MjpegView] Dimensions WxH: ', properties.width, properties.height);
            if(properties.height && properties.width) {
                this.imgTag.width = properties.width;
                this.imgTag.height = properties.height;
            }else {
                this.imgTag.width = 640;
                this.imgTag.height = 480;
            }
